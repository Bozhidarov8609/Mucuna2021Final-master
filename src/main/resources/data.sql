...
#
#  -- dogsEntity
--  INSERT mucuna071221.dogs (id, age,approved,breed,name,picture,sex,user_entity_id)
...
--  INSERT mucuna071221.events(id, name, picture, place, price, user_id)
...
--   INSERT mucuna071221.puppies(id, contact, description, name, picture, price, dog_id)
